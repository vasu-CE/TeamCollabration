            ...
            <Card key={project.id}>
              ...
              <CardContent>
                ...
                {project.technology?.map((tech, i) => (
                  <span key={i} className="mr-2">{tech}</span>
                ))}
              </CardContent>
            </Card>
          ))}
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Input name="technology" placeholder="Technologies (comma-separated)" required onChange={handleTechnologyChange} />
              <Input name="gitHubLink" placeholder="GitHub Link" required onChange={handleChange} />
              <Input name="semester" placeholder="Semester" required onChange={handleChange} />
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) => setFormData((prev) => ({ ...prev, isUnderSgp: e.target.checked }))}
                />
